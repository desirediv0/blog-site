...
function ResourcesContent() {
  ...
  }, [filters.accessType, filters.categorySlug, filters.page, filters.search]);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold mb-3 text-[var(--custom-500)]">
          Resources
        </h1>
        <p className="text-gray-600 max-w-2xl mx-auto">
          Discover trading guides, strategies, and educational resources to
        ...
        <Card className="p-12 text-center">
          <div className="max-w-md mx-auto">
            <p className="text-gray-600 text-lg mb-4">
              {filters.search
                ? `No resources found for "${filters.search}"`
                : hasActiveFilters
