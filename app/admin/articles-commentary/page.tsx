...
export default function ArticlesCommentaryPage() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-8">
            <div className="flex justify-between items-center mb-8">
                <h1 className="text-3xl font-bold">Latest Articles & Market Commentary</h1>
            ...
            <Card className="p-6 mb-6">
                <p className="text-gray-600">
                    Manage articles and market commentary that appear on the home page. Toggle featured status to show/hide articles.
                </p>
            </Card>

            {blogs.length === 0 ? (
                <Card className="p-8 text-center">
                    <p className="text-gray-600">No articles found. Create blogs to get started.</p>
                </Card>
            ) : (
